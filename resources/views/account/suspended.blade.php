    ...
    <x-section.basic parent-class="py-4 sm:py-6 lg:py-16 lg:px-56" class="flex justify-center lg:px-48">
        <div class="w-full">
            <div class="flex justify-center lg:justify-start pt-16 lg:pt-48">
                <div class="space-y-8">
                    <div>
                        <h3 class="text-2xl lg:text-6xl font-bold lg:font-extrabold -mt-2 lg:mt-0">계정이 비활성 되었습니다.</h3>
                        <p class="lg:mt-4">
                            회원님의 계정이 @if($isPermanent)무기한@else일시@endif 비활성 되었음을 알려드립니다.<br/>
                            계정 비활성에 관하여 궁금하신 사항이 있다면 <a href="https://cafe.naver.com/gamemmakers" class="link-indigo" target="_blank">커뮤니티</a>에 남겨주시면 확인 후 연락드리겠습니다.<br/>
                        </p>
                    </div>
