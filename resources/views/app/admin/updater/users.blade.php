                ...
                <div class="bg-white dark:bg-gray-900 overflow-hidden rounded-md border-x border-t border-gray-300 dark:border-gray-800">
                    <ul role="list" class="">
                        <template x-for="updater in data.load.data.data">
                            <li class="block">
                                <a :src="'/app/admin/user/' + updater.user_id" target="_blank" rel="noopener" class="block hover:bg-gray-50 border-b border-gray-300 dark:border-gray-800 font-mono">
                                        ...
                                        <div class="mt-2 sm:flex sm:justify-between">
                                            <div class="sm:flex">
                                                <div class="flex items-center text-sm text-gray-500">
                                                    ...
                                                    <p>
                                                    <p class="" x-text="updater.user_name"></p>
                                                    </p>
                                                </div>
