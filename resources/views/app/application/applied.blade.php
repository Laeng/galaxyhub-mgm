    ...
    <x-panel.galaxyhub.basics>
        <div class="grid grid-cols-1 items-center gap-3">
            ...
            <x-alert.galaxyhub.warning title="가입 심사 안내">
                <ol>
                    <li>가입 심사는 멀티플레이 게임 매니지먼트 스탭이 직접 처리하고 있습니다.</li>
                    <li>가입 완료까지 다소 시간이 걸릴 수 있는 점 양해 부탁드립니다.</li>
                </ol>
            </x-alert.galaxyhub.warning>
            <x-alert.galaxyhub.info title="디스코드, 네이버 카페, 쪽지를 확인해주세요.">
                <ol>
                    <li>가입 심사 중 추가 질의 또는 아르마 클랜 활동시 주의사항을 안내하기 위해 스탭이 연락드립니다.</li>
                    <li>원활한 가입을 위하여 디스코드, 네이버 카페, 쪽지을 자주 확인해주시면 감사드립니다.</li>
                </ol>
