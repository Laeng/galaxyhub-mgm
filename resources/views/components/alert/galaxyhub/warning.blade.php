<div class="rounded-md bg-yellow-50 dark:bg-gray-900 dark:border dark:border-yellow-500  p-4">
    <div class="flex">
        ...
        <div class="ml-3">
            <h3 class="text-sm font-bold text-yellow-800 dark:text-yellow-200">{{ $title }}</h3>
