...
<header class="{{ $parentClass }} fixed z-50">
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 h-[3.75rem] {{ $class }}">
        <div class="flex space-x-1.5 items-center items-self-center h-full">
            <div class="z-10">
                <a href="https://galaxyhub.kr" target="_blank" rel="noopener">
                    <p class="sr-only">갤럭시허브</p>
                    <svg class="h-7 md:hidden fill-current {{$logoHexCode}} hover:text-purple-500 htf htf-hover" viewBox="0 0 112.7 104.7" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg class="h-5 hidden md:block fill-current {{$logoHexCode}} hover:text-purple-500 htf htf-hover" viewBox="0 0 226 30.7" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="z-10">
                <svg  class="h-7 md:h-5 stroke-current stroke-2 {{$logoHexCode}} htf htf-hover" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 24">
