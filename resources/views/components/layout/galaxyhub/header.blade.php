        ...
        <div class="flex space-x-1.5 items-center items-self-center h-full">
            <div class="z-10">
                <a href="https://galaxyhub.kr" target="_blank" rel="noopener">
                    ...
                    <svg class="h-7 md:hidden fill-current {{$logoHexCode}} hover:text-purple-500" viewBox="0 0 112.7 104.7" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg class="h-5 hidden md:block fill-current {{$logoHexCode}} hover:text-purple-500" viewBox="0 0 226 30.7" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="z-10">
                <svg  class="h-7 md:h-5 stroke-current stroke-2 {{$logoHexCode}} " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 24">
            ...
            <div class="z-10">
                <a href="{{ mb_strtolower($websiteName) === 'mgm lounge' ? route('app.index') : route('welcome') }}">
                    <svg class="{{ $logoTextClass }} font-medium w-full h-5">
            ...
            <div class="grid" x-data="{modal_navigation: false}">
                <button type="button" class="z-10 focus:outline-none block lg:hidden" @click="modal_navigation = !modal_navigation;">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" x-show="!modal_navigation">
