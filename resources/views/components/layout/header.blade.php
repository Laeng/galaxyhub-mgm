<header class="{{ $parentClass }} fixed z-50">
    <div class="max-w-7xl mx-auto py-3 md:py-4 px-4 sm:px-6 lg:px-8 {{ $class }}">
        <div class="flex space-x-1.5 items-center">
            ...
            <div class="hidden lg:flex items-center space-x-4 {{ $menuTextClass }}">
                ...
                @elseauth
                    <a href="https://discord.gg/starcitizenkr" class="inline-flex items-center hover:text-[#5865F2]" target="_blank">
                        <svg class="h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
