<header class="{{ $parentClass }} fixed z-50">
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 h-[3.75rem] {{ $class }}">
        <div class="flex space-x-1.5 items-center items-self-center h-full">
            ...
            <div class="z-10">
                <svg  class="h-7 md:h-5 stroke-current stroke-2 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 24">
            ...
            <div class="grid {{ $menuTextClass }}" x-data="{modal_navigation: false}">
                <button type="button" class="z-10 focus:outline-none block lg:hidden" @click="modal_navigation = !modal_navigation;">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" x-show="!modal_navigation">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" x-cloak x-show="modal_navigation">
