<style>
    :root {
        --header-opacity: 0;
        --header-text-filter: 0;
    }
    .ho {
        --tw-bg-opacity: var(--header-opacity, 0);
    }
    .htf {
        filter: brightness(calc(1 + var(--header-text-filter, 0)));
    }
    .htf-hover:hover {
        filter: none;
    }
...
<header class="{{ $parentClass }} fixed z-50">
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 h-[3.75rem] {{ $class }}">
        <div class="flex space-x-1.5 items-center items-self-center h-full">
            ...
            <div class="grid" x-data="{modal_navigation: false}">
                <button type="button" class="z-10 focus:outline-none block lg:hidden" @click="modal_navigation = !modal_navigation;">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-gray-400 htf htf-hover" fill="none" viewBox="0 0 24 24" stroke="currentColor" x-show="!modal_navigation">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" x-cloak x-show="modal_navigation">
