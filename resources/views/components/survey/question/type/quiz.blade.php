        ...
        <div class="flex flex-col space-y-1 mt-4">
            @foreach($options as $option)
                <label class="inline-flex items-start">
                    ...
                    class="rounded-full dark:bg-gray-900 @error($question->key) border-red-600 @else border-gray-300 dark:border-gray-800 @enderror text-blue-600 shadow-sm focus:ring-blue-500 focus:ring focus:ring-offset-0 mt-1">
        ...
        <legend class="relative leading-6 font-medium text-gray-900 dark:text-gray-100 mb-0.5">
            ...
            <div class="text-red-500">
                @if($realAnswer === $answer)
                    <svg class="absolute -top-[0.55rem] -left-[0.95rem] h-10 w-10 mix-blend-multiply dark:mix-blend-normal" style="-webkit-mask-image: url('{{ asset('images/rubber.png') }}'); -webkit-mask-repeat:repeat; -webkit-mask-position: {{mt_rand(0, 64)}}px {{mt_rand(0, 64)}}px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                @else
                    <svg class="absolute -top-[0.55rem] -left-[0.95rem] h-10 w-10 mix-blend-multiply dark:mix-blend-normal" style="-webkit-mask-image: url('{{ asset('images/rubber.png') }}'); -webkit-mask-repeat:repeat; -webkit-mask-position: {{mt_rand(0, 64)}}px {{mt_rand(0, 64)}}px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
