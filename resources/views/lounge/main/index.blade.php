<x-sub-page website-name="MGM Lounge" title="메인">
    <x-section.basic parent-class="py-4 sm:py-6" class="flex justify-center">
        <div class="w-full">
            <div class="flex items-center space-x-2 md:space-x-4">
                <img class="rounded-full h-14 w-14" src="https://cdn.cloudflare.steamstatic.com/steamcommunity/public/images/avatars/ef/ef79c1a01213dca96e2ce73d74a5ec17278a9ce7_full.jpg" alt="프로필 이미지" />
                <div>
                    <h1 class="font-bold text-lg">안녕하세요! Laeng님.</h1>
                    <p class="text-sm text-gray-500">MGM Lounge 에 오신 것을 환영합니다.</p>
                </div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 font-bold rounded-lg border border-gray-300 mt-5">
                <div class="p-8 border-b lg:border-b-0 md:border-r border-gray-300 text-center text-red-600 rounded-t-lg md:rounded-tr-none lg:rounded-bl-lg hover:shadow-inner hover:bg-gray-200 hover:text-red-700">
                    <p class="text-sm">신청한 미션</p>
                    <p class="text-base text-black">12/05 20:00 아르마의 밤</p>
                </div>
                <div class="p-8 border-b lg:border-b-0 lg:border-r border-gray-300 text-center text-pink-600 md:rounded-tr lg:rounded-tr-none hover:shadow-inner hover:bg-gray-200 hover:text-pink-700">
                    <p class="text-sm">최근 참가 미션</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-6 gap-4">
                <div class="md:col-span-2 lg:row-span-2 bg-red-400 rounded-lg p-8 lg:p-16 shadow-lg hover:shadow-inner transform hover:translate-y-0.5">
                ...
                <div class="rounded-lg p-8 bg-green-400 shadow-lg hover:shadow-inner transform hover:translate-y-0.5">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right text-white h-full">
                            <p class="text-sm">MGM Updater</p>
                            <p class="text-2xl font-bold">다운로드</p>
                        </div>
                    </div>
                </div>

                <div class="rounded-lg p-8 bg-[#5865F2] shadow-lg hover:shadow-inner transform hover:translate-y-0.5">
                    <div class="flex items-center justify-between">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 mt-6 gap-4">
                ...
                <div class="rounded-lg py-8 pl-8 bg-white">
                    <p class="font-bold text-lg mb-4 pr-8">Updater</p>
                    <div class="pr-8 overflow-y-auto h-96 prose min-w-full">
