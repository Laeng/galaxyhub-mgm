<x-sub-page website-name="MGM Lounge" title="{{$title}}">
    <x-section.basic parent-class="py-4 sm:py-6 lg:py-16 lg:px-56" class="flex justify-center">
        <div class="w-full">
            <div class="bg-white rounded-lg p-4 lg:p-16">
                ...
                <div class="">
                    @if($hasSurvey)
                        ...
                        <div class="flex justify-center mt-4 space-x-2">
                            @if(!$hasAttend && !$isClosed)
                                <x-button.filled.md-blue type="button" onclick="location.href=''">
                                    출석하기
                    ...
                    @else
                        <x-survey.form :survey="$survey" :action="$action" submit-text="출석하기" back-link="{{ route('lounge.mission.read', $id) }}" />
                    @endif
                </div>
