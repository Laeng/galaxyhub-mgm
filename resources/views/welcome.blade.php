        ...
        <x-container.galaxyhub.basics class="py-8 lg:py-32">
            <div class="lg:flex items-center">
                ...
                <div class="basis-1/2 space-y-2 py-4 lg:py-0">
                    <p>종류의 모든 게임을 사랑하는 여러분을 환영합니다. 멀티플레이 게임 매니지먼트는 게임을 좋아하는 분들을 위한 공간입니다. 현재 많은 회원 분들의 도움으로 아르마3 클랜과 스타 시티즌 함대를 운영하고 있으며 비공개 서버 개설을 통해 러스트, 아크 서바이벌 이볼브, 마인크래프트와 같은 다양한 멀티 플레이 게임을 함께 즐기고 있습니다.</p>
                    <p>게임을 좋아하시는 여러분을 위해 멀티플레이 게임 매니지먼트의 운영진은 여러분들을 보좌하며 성심껏 보조할 것입니다. 다시 한번 방문 해주신 모든 분께 진심으로 감사를 전합니다.</p>
                </div>
            </div>
        </x-container.galaxyhub.basics>
    </div>
